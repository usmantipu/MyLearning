...
class IRMPurchaseOrderTableSearch extends Page {
	get purchaseSearch(){return browser.$('.react-grid-item*=Purchase Orders').$('input');}
	get lockedIcon(){return browser.$('.react-grid-item*=Purchase Orders').$('[data-testid="LockOpenIcon"]');}
	get lockedKey(){return browser.$('.react-grid-item*=Purchase Orders').$('.MuiInputAdornment-root');}
	get lockClosedIcon(){return browser.$('.react-grid-item*=Purchase Orders').$('[data-testid="LockIcon"]');}
	get highLightedText(){return browser.$('.react-grid-item*=Purchase Orders').$('.MuiDataGrid-virtualScrollerRenderZone').$('.highlight-text');}
	get clearSearchBox(){return browser.$('.react-grid-item*=Purchase Orders').$('[data-testid="CloseIcon"]')}
	get poAllRows(){return browser.$('.react-grid-item*=Purchase Orders').$('.MuiDataGrid-virtualScrollerRenderZone').$$('.MuiDataGrid-row');}
	get noDataMessage(){return browser.$('.react-grid-item*=Purchase Orders').$('.MuiDataGrid-overlayWrapperInner');}
	get firstPoRowData(){return browser.$('.react-grid-item*=Purchase Orders').$('.MuiDataGrid-virtualScrollerRenderZone').$$('.MuiDataGrid-cell');}
	get poColumnsHeader(){return browser.$('.react-grid-item*=Purchase Orders').$('.MuiDataGrid-columnHeadersInner').$$('.MuiDataGrid-columnHeader');}
...
module.exports = new IRMPurchaseOrderTableSearch();

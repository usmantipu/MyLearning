...
class crmStatusTypePriority extends Page {
    ...
    get ticketPriorityFromDrawer(){return this.dockHeader.$('[data-testid="RemoveCircleOutlineOutlinedIcon"]');}
    get ticketPriorityLowliItem(){return browser.$('li=Priority: Low');}
    get ticketPriorityLowFromDrawer(){return this.dockHeader.$('[data-testid="ArrowCircleDownOutlinedIcon"]');}
    get ticketPriorityHighFromDrawer(){return this.dockHeader.$('[data-testid="ArrowCircleUpOutlinedIcon"]');}
    get ticketTypeFromDrawer(){return browser.$('//*[@id="panel1a-header"]/div[1]/div[1]/button[2]');}
    get ticketyTypeSearchDrawer(){return browser.$('/html/body/div[2]/div[3]/div').$('input');}
    get selectFirstTicketTypeSearchResult(){return browser.$('/html/body/div[2]/div[3]/ul/div');}
    get ticketStatus(){return browser.$('//*[@id="panel1a-header"]/div[1]/div[1]/button[3]');}
    get ticketStatusSearch(){return browser.$('//*[@id="basic-menu"]/div[3]/ul').$('input');}
    ...
    get ticketPriorityFromDialog(){return browser.$('[data-testid="RemoveCircleOutlineOutlinedIcon"]');}
    get selectedTypeFromDialog(){return browser.$('div*=Ticket Type:').$$('.text-muted');}
...
module.exports = new crmStatusTypePriority();

...
//	get pageLoadError(){return browser.$('.MuiGrid-align-items-xs-center')} //ui-upgrade
	...
	get SuspendedIcon (){var allsuspendedicons = browser.$('#subscriberPage').$('.bottomRightGrid').$('.ReactVirtualized__Grid__innerScrollContainer').$$('path');
								...
								if(allsuspendedicons[i].getAttribute('d')=='M12 5.9c1.16 0 2.1.94 2.1 2.1s-.94 2.1-2.1 2.1S9.9 9.16 9.9 8s.94-2.1 2.1-2.1m0 9c2.97 0 6.1 1.46 6.1 2.1v1.1H5.9V17c0-.64 3.13-2.1 6.1-2.1M12 4C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4m0 9c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4')
									{totalcount++;}
	  							}
								console.log('total suspended records are '+totalcount);
								return totalcount;
						}
	...
	get selectDueSecondSubscriber(){ return browser.$('//*[@id="subscriberPage"]/div/div[1]/div[1]/div/div/div/div[2]/div/div/div[10]');}
	get allsubscribersData(){return browser.$('.bottomRightGrid').$('.ReactVirtualized__Grid__innerScrollContainer').$$('p');}
	get dotMenu(){ return browser.$('#subscriberPage').$('.bottomRightGrid').$('.MuiTableCell-root');}
	get dotMenuButton(){ return this.dotMenu.$('button');}
	...
	get selectFirstEquipmentItem(){return browser.$('.MuiDialog-paper').$('.MuiDialogContent-root').$('.MuiTableBody-root').$('tr');}
	...
	get closePopUp(){return browser.$('//*[@id="app-inner"]/div[2]/div[2]/main/div[4]/div/div[3]/div[6]/div/div[1]/div/div[2]/button');}
	/**top menu */
	...
	get btnCRMFromMenu(){return browser.$('#settings-tab-3');}
    open() {
        super.open('login');

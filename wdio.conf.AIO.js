    ...
    reporters: ['spec',
                /*[
                    'junit',
                    {
                        ...
                        useBrowserName: true,
                        suiteNameFormat: /[^a-zA-Z0-9]+/, // replace invalid characters with underscore
                        classNameFormat: (options) => {
                            return `${options.capabilities.browserName}.${options.suite}`;
                        },
                        titleFormat: (options) => {
